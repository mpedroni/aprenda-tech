...
public class FeedbacksConfig {
    ...
    public FeedbacksConfig(FeedbackJpaRepository feedbackRepository, UserJpaRepository userRepository, CourseJpaRepository courseRepository, EnrollmentJpaRepository enrollmentRepository) {
    ...
    public RegisterFeedbackUseCase registerFeedbackUseCase() {
        return new RegisterFeedbackUseCase(feedbackRepository, userRepository, courseRepository, enrollmentRepository);
    }
}
